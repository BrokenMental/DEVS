...
// "C:/Documents and Settings/Bernie/My Documents/MyDocs/book/DynamicDataEngin/DDEProj/src/";

	   //	  "C:/DDEProjWDEVS3.1/src/";
//"C:/Users/Bernie/Documents/MyDocs/book/DynamicDataEngin/DDEProjWDEVS3.1/src/";
// "C:/DDEProjWDEVS3.1/src/" "C:/DDEProjWDEVS3.1/DDEProjWDEVS3.1NetBeans/src/";
   "C:/DDEProjWDEVS3.1NFDDEVS/src/";
   //    static public String projectPath = "C:/Documents and Settings/Owner/My Documents/MyDocs/book/DynamicDataEngin/DDEProj/src/";
...
//
    ...
    public static String addtabs(String text) {
        ...
        if (textlines.length<3)return text;//bpz
        text = textlines[0] + "\n" + textlines[1] + "\n" + textlines[2] + "\n";
...
// Retrieves contents of fileString, appends moreStuff, and stores back to file
    ...
    public static void main(String argv[]) {
        ...
        //System.out.println(f.chooseFileString("C:/JBuilder9/jdk1.4/bin/"));
        //System.out.println(f.getFile("C:/JBuilder9/jdk1.4/bin/"));
        //System.out.println(f.getFile(f.chooseFileString("C:/JBuilder9/jdk1.4/bin/")).isFile());

//f.writeToChooseFile("testtext");
        // System.out.println(f.readFromFile("C:/DEVSJAVA30-Apps/src/XML/testFile.txt"));
//System.out.println(f.readFromChooseFile());
//f.writeToChooseFile(f.readFromChooseFile());
//System.out.println(f.chooseMultiFileString(".").length);
        f.appendToFile("C:/DEVSJAVA30-Apps/src/XML/testFile.txt", "newStuff");
        System.exit(0);
