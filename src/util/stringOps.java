...
public class stringOps {
    ...
    public static EnsembleSetUtil toEnsembleSet(Set s) {
        EnsembleSetUtil r = new EnsembleSetUtil();
        r.addAll(s);
        return r;
    }
...
// Maps ensembleSet into StringArray, assuming ensembleSet is a set of strings
    public static String[] toStringArray(EnsembleSetUtil names) {
...
// Maps String Array into an ensembleSet
    public static EnsembleSetUtil toEnsembleSet(String[] names) {
        EnsembleSetUtil es = new EnsembleSetUtil();
        for (int i = 0; i < names.length; i++) {
            es.add(names[i]);
        }
        return es;
    }
    // Maps String Array into an Queue
        public static Queue toQueue(String[] names) {
            Queue es = new Queue();
            for (int i = 0; i < names.length; i++) {
                es.add(names[i]);
            }
