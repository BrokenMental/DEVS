...
public class PortBox extends JPanel
{
    ...
    {
      if(portName_.startsWith("#")&&portName_.endsWith("#"))   //Xiaolin Hu, March 2006
        portName = "#"+portName_.hashCode();
      else
        portName = portName_;
        in = in_;
        ...
        if (in && component != null) {
            ...
            addMouseListener(new MouseAdapter() {
              ...
              modelView.mouseReleasedOnPort(portName,component);
            }
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
              ...
              modelView.mouseEnteredPort(portName);
            }
            ...
            public void mouseClicked(MouseEvent e) {
              ...
              if (e.getClickCount() == 2) {
                ...
                modelView.mouseClickedTwiceOnPort(portName, component);

                if (e.isControlDown()) {
                  modelView.clearFrozenCoupling(portName);
                }
                else
                if (e.isAltDown()) {
                  modelView.clearAllFrozenCouplings();
                }
              }
            }

            public void mousePressed(MouseEvent e){
              modelView.mousePressedOnPort(portName, component);
