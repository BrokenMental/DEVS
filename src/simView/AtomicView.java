...
//        atomic.printOutports();
    ...
    protected class CompBox extends JPanel
    {
         ...
         */
        protected Font nameFont = new Font("SansSerif", Font.BOLD, 10); //10 by saurabh
         ...
         * font's associated metrics object.
         */
        protected Font phaseFont = new Font("SansSerif", Font.BOLD, 12); //12 by saurabh
        ...
        public Dimension getPreferredSize()
        {
            ...
            size.width = Math.max(nameWidth + 10, 60);  //saurabh
