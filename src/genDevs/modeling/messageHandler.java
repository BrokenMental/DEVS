...
//by saurabh
  ...
  return new content((port)p,(GenCol.entity)value);
  }
  public content makeContent(String p,GenCol.entity value){  //for use in usual devs
  ...
  public IODevs getParent() {return null;}   //Xiaolin Hu
  public IODevs findModelWithName(String modelName) {return null;}  //Xiaolin Hu
