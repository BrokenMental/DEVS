 ...
 */
public class RTCentralCoordServer extends RTCentralCoord
{
    /**
     ...
     *                          have connected.
     */
    public RTCentralCoordServer(coupledDevs devs, int numIterations_,
     ...
     */
    public RTCentralCoordServer(coupledDevs devs, int numIterations)
    {
   ...
   //             new SimulatorProxyForCentral(socket, RTCentralCoordServer.this);
            }
